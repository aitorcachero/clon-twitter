...
export default function CardUser({ fullUser }) {
  ...
  return (
    <div className="flex flex-col w-full justify-center items-center">
      {user && (
        <article
          className="border min-w-[4000px] border-slate-700 rounded-xl bg-zinc-900 p-6 w-full md:w-[500px] flex flex-col justify-between gap-2 my-4"
          style={{
        ...
        >
          ...
          <section className="flex flex-row justify-center items-center gap-10 p-2 md:p-4 bg-slate-800 rounded">
