    ...
    <div className="flex flex-col w-full justify-center items-center">
      {user && (
        ...
        >
          <header className="flex flex-col justify-center items-center">
            <div className="flex flex-row justify-between items-end w-full">
              ...
              {authUser?.id === fullUser?.user.id && (
                <button
                  className={`rounded-lg border border-blue-600 bg-slate-300 px-4 py-2 font-semibold text-black`}
                >
                  Editar
                </button>
              )}
          ...
          <section className="flex flex-row justify-center items-center gap-10 p-6 md:p-4 bg-slate-800 rounded">
