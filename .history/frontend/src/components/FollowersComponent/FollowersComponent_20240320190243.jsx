...
export default function FollowersComponent({ userFollower }) {
  ...
  return (
    <article
      className="border border-slate-700 rounded-xl bg-zinc-900 p-2 w-full lg:w-[300px] flex flex-row justify-between gap-2 my-2"
      style={{
    ...
    >
      ...
      <main className="flex flex-col justify-start items-center w-3/4 text-sm">
        <p>
