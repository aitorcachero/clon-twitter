...
export default function FollowersComponent({ userFollower }) {
  ...
  return (
    <article
      className="border border-slate-700 rounded-xl bg-zinc-900 p-2 w-full lg:w-[400px] flex flex-row justify-between gap-2 my-2"
      style={{
        background: 'linear-gradient(71deg, #080509, #1a171c, #080509)',
        backgroundClip: 'padding-box',
      }}
    >
      <div className='flex justify-center items-center className="w-1/4"'>
        <img src={userDefaultIcon} width={40} />
      </div>
