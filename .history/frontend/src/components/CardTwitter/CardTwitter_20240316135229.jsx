    ...
    >
      <header className="flex flex-row justify-center items-center">
        <span className="text-white">
          {tweet.name} {tweet.surname} - <spanclassName="text-orange-600">@{tweet.username}</spanclassName=>
        </span>
      </header>
      {/* <a href={''}> */}
      ...
      <p className="text-blue-600">@{tweet.username}</p>
      <p className="text-orange-600">{formatDate(tweet.createdAt)}</p>
