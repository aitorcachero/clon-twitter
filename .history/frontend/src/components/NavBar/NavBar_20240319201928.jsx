...
export default function NavBar() {
  ...
  return (
    <nav className="w-full h-16 fixed  top-0 flex flex-row justify-center items-center bg-black opacity-55 blur-sm z-1">
      <div className="flex flex-row w-[500px] justify-between items-center px-10">
        <NavLink to="/">
          <img src={logoTw} width={60} className="blur-none z-30" />
        </NavLink>
        {authUser ? (
