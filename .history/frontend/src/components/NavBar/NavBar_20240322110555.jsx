...
export default function NavBar() {
  ...
  return (
    <nav className="w-full h-16 fixed  top-0 flex flex-row justify-center items-center bg-[rgba(13,15,16,.28)] will-change-auto opacity-100  backdrop:blur-sm z-10">
