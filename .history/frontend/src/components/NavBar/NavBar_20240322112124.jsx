...
export default function NavBar() {
  ...
  return (
    <div className="sticky top-0 w-full h-16 z-10 bg-transparent flex flex-row justify-center items-center border-b-transparent">
      <nav
        className=" absolute   top-0 left-0 right-0 bottom-0 flex flex-row justify-center items-center
        opacity-100   backdrop:filter backdrop-blur-xl saturate-150"
        style={{
