...
import retweetsImg from '../../icons/assets/card-retweets.svg';

export default function CardTweeter({ tweet }) {
  return (
    <article className="border border-slate-700 rounded-xl bg-zinc-900 p-6 w-96 flex flex-col justify-between gap-2">
      <h2>
